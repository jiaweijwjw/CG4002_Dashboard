...
export default function User2({team}) {
 ...
 /*  const [team, setTeam] = useState(dataFromInitialSend); // returns the current state and a function that updates it.
  ...
  function currentSessionAxis(team) {
    var num_of_iterations = team.users[1].user_session_graph.length;
    console.log(num_of_iterations);
    var userCurrentSessionStats = {
      data: {
        labels: [] = x_axis(num_of_iterations),
        series: [team.users[1].user_session_graph]
      }
    }
    console.log(team.users[1].user_session_graph);
            ...
            <Card>
              <CardHeader color="warning" /* stats */ icon>
                ...
                <h3 className={classes.cardTitle}>
                  {getPerformanceGrade(team.users[1].iteration_score)} {/* <small>GB</small> */}
                </h3>
              </CardHeader>
              <CardFooter stats>
